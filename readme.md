...
get_db_row($id,$nombre_campo,$tabla,$campo)											// [NUEVO] Devuelve string de interés - $nombre_campo = campo de la tabla que se quiere obtener; $id = ''; $campo = campo por el cual se quiere buscar.
